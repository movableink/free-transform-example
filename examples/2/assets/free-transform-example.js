...
define('free-transform-example/controllers/application', ['exports', 'ember'], function (exports, Em) {
  ...
  var ApplicationController = Em['default'].Controller.extend({
    model: Em['default'].Object.create({ top: 50, left: 50, width: 300, height: 200 })
  });
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        component(env, morph4, context, "free-transform", {"model": get(env, context, "model")}, child0);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el2,"class","handle tl");
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","handle tr");
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","handle bl");
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","handle br");
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
      ...
      render: function render(context, env, contextualElement) {
        ...
        attribute(env, attrMorph1, element1, "style", concat(env, ["position: absolute; top: ", get(env, context, "top"), "px; left: ", get(env, context, "left"), "px; width: ", get(env, context, "width"), "px; height: ", get(env, context, "height"), "px;"]));
        return fragment;
      }
    };
  }()));
...
if (runningTests) {
  ...
  require("free-transform-example/app")["default"].create({"name":"free-transform-example","version":"0.0.0.9d52783b"});
}
