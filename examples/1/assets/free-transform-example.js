...
define('free-transform-example/components/free-transform', ['exports', 'ember'], function (exports, Em) {
  ...
  var FreeTransform = Em['default'].Component.extend({
    ...
    width: Em['default'].computed.alias("model.width"),
    height: Em['default'].computed.alias("model.height"),
...
if (runningTests) {
  ...
  require("free-transform-example/app")["default"].create({"name":"free-transform-example","version":"0.0.0.35d643f8"});
}
